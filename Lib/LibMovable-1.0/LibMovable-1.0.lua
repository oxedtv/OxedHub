...
elseif locale == "deDE" then
	L["Center horizontally"] = "Horizontal zentrieren" -- Needs review
L["Center vertically"] = "Vertikal zentrieren" -- Needs review
L["Control+drag: move horizontally."] = "Strg+ziehen: Horizontall bewegen." -- Needs review
L["Controls:"] = "Steuerung:" -- Needs review
L[" (disabled)"] = " (Deaktiviert)" -- Needs review
L["Drag: move."] = "Ziehen: Frei Bewegen." -- Needs review
L["Enabled"] = "Aktiviert" -- Needs review
L["Hide all moving handles"] = "Alle Beweglichen-Handle ausblenden" -- Needs review
L["Hide this moving handle"] = "Diesen Beweglichen-Handle Ausblenden" -- Needs review
L[" (locked down in combat)"] = " (Im Kampf gesperrt)" -- Needs review
L["Mousewheel: change scale."] = "Mausrad: Skalierung ändern." -- Needs review
L["Reset to default position"] = "Zurück auf die Standard Position setzten" -- Needs review
L["Right-click: open menu."] = "Rechtsklick: Menü öffnen." -- Needs review
L["Shift+drag: move vertically."] = "Shift+ziehen: Vertikal bewegen." -- Needs review
L["Shift+right-click: enable/disable."] = "Shift+Rechtsklick: aktivieren/deaktivieren." -- Needs review
