...
WhatsNew.RELEASES = {
    {
        ...
        lines = {
            ...
            { "ADDED", "Cursor: rest the mouse and the sparks spiral around the pointer instead of trailing behind it -- the wait before they start is yours to set. A ring spreads from every click, shaking the mouse flares the glow up to find it, and the pointer stays drawn where it froze while the right button steers." },
